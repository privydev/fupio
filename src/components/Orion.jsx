...
export default class Orion extends Component {
  ...
  componentDidMount(){
    var w = c.width = window.innerWidth,
		...
		this.state.sinX = this.state.sinY = 0,
		this.state.cosX = this.state.cosY = 0,
...
Connection.prototype.setScreen = Data.prototype.setScreen = function(){
	...
	var Y = y;
	y = y * this.state.cosX - z * this.state.sinX;
	z = z * this.state.cosX + Y * this.state.sinX;
	
	// rot on Y
	var Z = z;
	z = z * this.state.cosY - x * this.state.sinY;
	x = x * this.state.cosY + Z * this.state.sinY;
...
function anim(){
	...
	this.setState({cosX: Math.cos( rotX )});
	this.setState({sinX: Math.sin( rotX )});
  this.setState({cosY: Math.cos( rotY )});
  this.setState({sinY: Math.sin( rotY )});
